...
<head>
    ...
    <title>Quem Somos - Narraverso</title>
...
<body>
   ...
   <header>
        ...
        <nav class="nav-bar-principal">
            ...
            <div id="menu" class="nav-list-menu">
                <ul>
                    ...
                    <li class="nav-item"><a href="quemSomos.php" class="nav-link"><img src="imagens/quem-somos-verde.png" alt="quem-somos">  Quem Somos</a></li>
    ...
    <div class="conteudo-quem-somos">
            <h1>Quem Somos</h1>
            <p>No <strong>Narraverso</strong>, acreditamos no poder das histórias de transformar realidades, conectar pessoas e inspirar emoções. Somos um espaço dedicado à paixão por narrativas – sejam elas em forma de livros, filmes ou séries.</p>
            <p>Nossa missão é criar um ambiente onde leitores, cinéfilos e aficionados por entretenimento possam se reunir, compartilhar suas opiniões e descobrir novas obras. Acreditamos que cada história tem o poder de mudar perspectivas, e estamos aqui para ajudar você a encontrar aquelas que realmente fazem a diferença.</p>
            <p>Por meio de resenhas, recomendações e um banco de dados de obras cuidadosamente selecionadas, queremos proporcionar aos nossos usuários uma plataforma rica, interativa e envolvente. No <strong>Narraverso</strong>, você é parte fundamental dessa jornada literária e cinematográfica!</p>
            <p>Junte-se a nós e venha explorar o <strong>Narraverso</strong> – onde as histórias nunca acabam, apenas começam.</p>
            <p>Se encontrar algum problema ou precisar de ajuda, entre em contato com o suporte do <strong>Narraverso.</strong>
            <br><br>
            E-mail: <a href="#">contato@narraverso.com</a>
            </p>
            <br>
            <br>
