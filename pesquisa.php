...
<head>
    ...
    <title>Pesquisa - Narraverso</title>
   ...
   <header>
    ...
    <form method="POST">
        ...
        <div class="container-principal-obras">
            ...
            <?php 
                ...
                $sql = "SELECT nome, fotoPerfil, categoria, genero FROM tcc_obra WHERE nome LIKE '$pesquisa%'"; //like verifica se pesquisa é igual nome da obra. % por antes (qualquer letras antes de pesquisa) e depois (qualquer letras depois de pesquisa)
                ...
                if (mysqli_num_rows($stmt) > 0) { //quatas linhas retornou da nossa pesquisa
                    while ($dados = mysqli_fetch_assoc($stmt)){ //mostra stmt da pesquisa 
            ...
            <?php echo '<h2 class="contas-titulo" id="contas-titulo"><br>CONTAS:</h2>'; ?>
            <ul class="container-obras">
                <?php
                ...
                if ($usuarioLogin) {
                    $loginSessao = mysqli_real_escape_string($conn, $_SESSION['login']);
                    $sql2 = "SELECT login, fotoPerfil FROM tcc_pessoa WHERE login LIKE '$pesquisa%' AND login != '$loginSessao'";
                    ...
                    $sql2 = "SELECT login, fotoPerfil FROM tcc_pessoa WHERE login LIKE '$pesquisa%'"; //like verifica se pesquisa é igual login da obra. % por antes (qualquer letras antes de pesquisa) e depois (qualquer letras depois de pesquisa)
                    ...
                    echo '<li class= "sem_resultado" id="sem_resultado">
                        <img src="imagens/sem-pesquisa.png">
                    </li>';
    ...
    <div id="filtroModal" class="filtro-overlay">
        <div class="filtro-container">
            ...
            <a class="fechar-filtro">Voltar</a>
