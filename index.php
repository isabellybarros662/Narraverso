...
<body>
   ...
   <header>
    ...
    <!--Mostrar as obras-->
    <div class="container-principal-obras" id="container-principal-obras">
        ...
        <ul class="container-obras-index" id="container-livro">
            ...
            <span class="seta-direita">
                <img id="setaDireitaLivro" src="imagens/seta-direita-obra-verde.png" alt="seta direita">
            </span>
        </ul>    
    </div>
...
<ul class="container-obras" id="container-obras" style="display: none;">
    <?php 
        require("tccbdconnecta.php");
        ...
        $sql4 = "SELECT nome, fotoPerfil, categoria, genero FROM tcc_obra";
        ...
        if (mysqli_num_rows($resultado4) > 0) { //quatas linhas retornou da nossa pesquisa
            while ($dados = mysqli_fetch_assoc($resultado4)){ //mostra resultado da pesquisa 
                $fotoObra = !empty($dados['fotoPerfil']) ? $dados['fotoPerfil'] : 'imagens/imagem-obras.png';
                $nome = $dados['nome'];
                $categoria = $dados['categoria'];
                $genero = $dados['genero'];
    ...
    <?php 
        if (isset($_SESSION['sucessoEmail'])) {
            include 'sucesso_email.html';
            unset($_SESSION['sucessoEmail']); //para exibir apenas uma vez
        }
    ?>
